...
<div class="bodyArea">
    ...
    <div class="body-R">
        ...
        <form method="POST" action="formcustdb.php" class="formsty">
            <div class="formtab">
                ...
                <li>
                    地址：<input type="text" id="custAdds" class="chkval" name="custAdds" size="80" minlength="10"></li>
                <li>
                    生日：<span style="font-size:12pt; color:#FF0000">西元年</span>
                    <input type="text" id="birday_Y" class="chkval chkolnynum" name="birday_Y" size="5" maxlength="4" minlength="4">
                    <select size="1" id="birday_M" class="chkval" name="birday_M">
                    ...
                    <select size="1" id="birday_D" class="chkval" name="birday_D">
